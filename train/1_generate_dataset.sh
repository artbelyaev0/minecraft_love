...
OUTPUT_DIR_CONTRACTOR=data/dataset_contractor_mineclip/
...
# N_EPISODES_MIXED_AGENTS=2267

# xvfb-run --auto-servernum python steve1/data/generation/gen_mixed_agents.py \
