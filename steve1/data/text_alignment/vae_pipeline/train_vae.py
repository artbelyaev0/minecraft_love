...
def main(args):
    print('Load data...')
    with open(args.path_mineclip, 'rb') as f:
        all_text_embeddings = pickle.load(f)
    with open(args.path_clip4mc, 'rb') as f:
        all_visual_embeddings = pickle.load(f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_mineclip', type=str, default='data/vae_data/data.pkl')
    parser.add_argument('--path_clip4mc', type=str, default='data/vae_data/data.pkl')
